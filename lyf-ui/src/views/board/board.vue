  ...
  <div class="app">
    ...
    <div class="card-groups">
      <CardGroup v-for="(cardGroup) in r.cardGroups" :key="cardGroup.id" :title="cardGroup.name" :color="cardGroup.color"
        :cards="cardGroup.cards" :cardGroupId="cardGroup.id" class="card-group" @card-changed="refresh" @edit-card-group="handleEdit" @delete-card-group="handleDelete"  />
      <div class="card-groups new-card-groups" @click="handleAdd()">
